...
// TradeMe API credentials - these will be overridden by environment variables
export const CONSUMER_KEY = process.env.TRADEME_CONSUMER_KEY || '05853D50C9B49D0BBF512C4F7C288098';
export const CONSUMER_SECRET = process.env.TRADEME_CONSUMER_SECRET || 'EE038BB9632A0BB6E1A6637555067E24';
