-- This file contains the same migration as 20250314000000_initial_schema.sql
-- but formatted to be run directly in the Supabase SQL editor
-- Copy and paste this entire file into the SQL editor in the Supabase dashboard
